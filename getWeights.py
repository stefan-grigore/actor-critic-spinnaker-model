...
input1 = sim.Population(3, sim.external_devices.SpikeInjector(), label="input1")

pre_pop = sim.Population(3, sim.IF_curr_exp(tau_syn_E=100, tau_refrac=50), label="pre_pop")
post_pop = sim.Population(3, sim.IF_curr_exp(tau_syn_E=25, tau_refrac=100), label="post_pop")
